...
export default function handleTyping(
	...
	instance
		...
		.type(
			'<span style="cursor: pointer;" onclick="displayWebsite()">Successfully deployed the website, avaible at <u>http://localhost:5500</u>. click <b><u>HERE</u></b> to open it</span>',
			{ instant: true },
		)
		.exec(() => {
			setTimeout(() => {
